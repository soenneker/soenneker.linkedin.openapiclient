...
namespace Soenneker.LinkedIn.OpenApiClient.Models
{
    ...
    public partial class ConversionsApiOperation6CCreateANewConversionRuleWithNoCampaignsAssociationRequest : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.LinkedIn.OpenApiClient.Models.ConversionsApiOperation6CCreateANewConversionRuleWithNoCampaignsAssociationRequest"/> and sets the default values.
        /// </summary>
        public ConversionsApiOperation6CCreateANewConversionRuleWithNoCampaignsAssociationRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.LinkedIn.OpenApiClient.Models.ConversionsApiOperation6CCreateANewConversionRuleWithNoCampaignsAssociationRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.LinkedIn.OpenApiClient.Models.ConversionsApiOperation6CCreateANewConversionRuleWithNoCampaignsAssociationRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.LinkedIn.OpenApiClient.Models.ConversionsApiOperation6CCreateANewConversionRuleWithNoCampaignsAssociationRequest();
        }
        /// <summary>
