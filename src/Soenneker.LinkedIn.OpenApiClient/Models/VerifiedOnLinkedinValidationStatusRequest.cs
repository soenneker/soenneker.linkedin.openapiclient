...
namespace Soenneker.LinkedIn.OpenApiClient.Models
{
    ...
    public partial class VerifiedOnLinkedinValidationStatusRequest : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The validationQueries property</summary>
...
#nullable restore
        ...
        /// </summary>
        public VerifiedOnLinkedinValidationStatusRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.LinkedIn.OpenApiClient.Models.VerifiedOnLinkedinValidationStatusRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.LinkedIn.OpenApiClient.Models.VerifiedOnLinkedinValidationStatusRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.LinkedIn.OpenApiClient.Models.VerifiedOnLinkedinValidationStatusRequest();
        }
        /// <summary>
