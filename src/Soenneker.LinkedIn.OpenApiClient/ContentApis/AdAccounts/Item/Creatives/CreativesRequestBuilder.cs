...
using System;
namespace Soenneker.LinkedIn.OpenApiClient.ContentApis.AdAccounts.Item.Creatives
{
    /// <summary>
    /// Builds and executes requests for operations under \content-apis\adAccounts\{adaccountId}\creatives
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class CreativesRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.LinkedIn.OpenApiClient.ContentApis.AdAccounts.Item.Creatives.CreativesRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreativesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/content-apis/adAccounts/{adaccountId}/creatives{?action*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.LinkedIn.OpenApiClient.ContentApis.AdAccounts.Item.Creatives.CreativesRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreativesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/content-apis/adAccounts/{adaccountId}/creatives{?action*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.LinkedIn.OpenApiClient.ContentApis.AdAccounts.Item.Creatives.CreativesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.LinkedIn.OpenApiClient.ContentApis.AdAccounts.Item.Creatives.CreativesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.LinkedIn.OpenApiClient.ContentApis.AdAccounts.Item.Creatives.CreativesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// You can sponsor an existing organic post that has been serving your company page followers and gone viral.This API creates a sponsored content by adding the action as createInline.
        /// </summary>
