...
using System;
namespace Soenneker.LinkedIn.OpenApiClient.ContentApis.Rest.Posts
{
    /// <summary>
    /// Builds and executes requests for operations under \content-apis\rest\posts
    /// </summary>
    ...
    public partial class PostsRequestBuilder : BaseRequestBuilder
    {
        ...
        public PostsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/content-apis/rest/posts{?ids*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.LinkedIn.OpenApiClient.ContentApis.Rest.Posts.PostsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PostsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/content-apis/rest/posts{?ids*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.LinkedIn.OpenApiClient.ContentApis.Rest.Posts.PostsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.LinkedIn.OpenApiClient.ContentApis.Rest.Posts.PostsRequestBuilder WithUrl(string rawUrl)
        {
